  ...
  return (
    <div className="image-converter-modal-overlay">
      <div className="image-converter-modal">
        <div className="image-converter-modal-content border-0 shadow-lg">
            ...
            <div className="row g-0">
                ...
                <div className="p-3">
                  ...
                  <div className="image-preview-container">
                    {activeTab === 'preview' ? (
                      ...
                      <div className="row g-3 w-100 p-3">
                        <div className="col-6">
              ...
              <div className="col-md-5">
                <div className="p-3">
                  ...
                  {/* Formato */}
                  <div className="mb-4">
                    <label className="form-label small fw-bold">Formato de salida</label>
                    <div className="btn-group w-100" role="group">
                      {['webp', 'jpeg', 'png'].map(format => (
                        <button
                          key={format}
                          type="button"
                          className={`btn ${conversionOptions.format === format ? 'btn-primary' : 'btn-outline-secondary'}`}
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      type="range"
                      className="form-range quality-slider"
                      min="10"
                      max="100"
                      step="5"
                    ...
                    <div className="btn-group w-100 mb-2" role="group">
                      {[
                        ...
                        <button
                          key={size.label}
                          type="button"
                          className={`btn ${conversionOptions.maxWidth === size.width ? 'btn-primary' : 'btn-outline-secondary'}`}
                  ...
                  <div className="mb-4">
                    <div className="form-check form-switch">
                      <input
                        ...
                        disabled={isConverting}
                      />
                      <label className="form-check-label small" htmlFor="keepOriginal">
                  ...
                  {/* Estadísticas */}
                  {stats && (
                    <div className="alert alert-info stats-container">
          ...
          {/* Footer */}
          <div className="image-converter-modal-footer">
